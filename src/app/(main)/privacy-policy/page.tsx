    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white shadow-md rounded-lg p-8">
          ...
          <p className="text-sm text-gray-600 mb-8">Effective date: October 06, 2018</p>
          
          <div className="space-y-6 text-gray-700">
            <p>
              Empire Smoke Distributors ("us", "we", or "our") operates the www.EmpireSmokedist.com website 
              (the "Service").
            </p>
            ...
            <p>
              ...
              Policy for Empire Smoke Distributors is managed through Free Privacy Policy.
            </p>
            ...
            <p>
              ...
              and Conditions, accessible from www.empiresmokedist.com
            </p>
            
            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Information Collection And Use</h2>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Use of Data</h3>
            <p>Empire Smoke Distributors uses the collected data for various purposes:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Transfer Of Data</h3>
            <p>
            ...
            <p>
              Empire Smoke Distributors will take all steps reasonably necessary to ensure that your data is 
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Disclosure Of Data</h3>
            <h4 className="text-lg font-medium text-gray-800 mt-4 mb-2">Legal Requirements</h4>
            <p>
              Empire Smoke Distributors may disclose your Personal Data in the good faith belief that such 
              action is necessary to:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>To comply with a legal obligation</li>
              <li>To protect and defend the rights or property of Empire Smoke Distributors</li>
              <li>To prevent or investigate possible wrongdoing in connection with the Service</li>
              <li>To protect the personal safety of users of the Service or the public</li>
              <li>To protect against legal liability</li>
            </ul>
            
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Security Of Data</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Links To Other Sites</h3>
            <p>
            ...
            <ul className="list-disc pl-6 mt-2 mb-6 space-y-1">
              <li>By email: <a href="mailto:EmpireSmokeDist@gmail.com" className="text-indigo-600 hover:text-indigo-900">EmpireSmokeDist@gmail.com</a></li>
              <li>By phone number: <a href="tel:5166822888" className="text-indigo-600 hover:text-indigo-900">516-682-2888</a></li>
            </ul>
          </div>
        </div>
      </main>
