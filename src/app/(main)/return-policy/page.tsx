      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-6">
          <div className="flex items-center text-sm text-gray-500">
            ...
            <span className="text-black font-medium">Return Policy</span>
          </div>
        </div>
        
        <div className="bg-white shadow-sm border border-gray-200 p-8 fade-in">
          <h1 className="text-3xl font-light text-gray-900 mb-8 tracking-tight">Return Policy</h1>
          
          <div className="space-y-6 text-gray-700">
            <section className="border-l-4 border-black pl-4 py-1">
              <h2 className="text-xl font-medium text-gray-900 mb-4">Return Policy:</h2>
              <p className="mb-4">
                Empire Smoke Distributors is dedicated to our customers' 100% satisfaction. We will issue a <span className="font-medium text-black">refund/credit</span> if you are not satisfied with your purchase and notify us within <span className="font-medium text-black">14 days</span> of product receipt. It must be <span className="font-medium text-black">returned</span> in the original packaging and in salable condition.
              </p>
              <p className="text-gray-800 font-medium">
                Returned products after 14 days are subject to a 10% <span className="text-black">restocking charge</span>.
              </p>
            </section>
            ...
            <div className="bg-red-50 p-5 border border-red-200 text-red-800">
              <p className="font-medium">Note: All E-Liquid Hardware & Cartridges are Final Sale</p>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="bg-white shadow-sm border border-gray-200">
                <ul className="divide-y divide-gray-200">
                  <li className="p-4 flex items-start">
                    <div className="flex-shrink-0 bg-gray-100 p-2 mt-0.5">
            ...
            <div className="mt-8 bg-gray-50 p-5 border border-gray-200">
              <h3 className="text-lg font-medium text-gray-800 mb-2">Need Help?</h3>
              <p className="text-gray-700 mb-4">If you have any questions about our return policy or need assistance with a return, our customer service team is here to help.</p>
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                <a 
                  href="mailto:EmpireSmokeDist@gmail.com" 
                  className="inline-flex items-center px-4 py-2 text-sm uppercase tracking-wider font-medium text-white bg-black hover:bg-gray-900 transition-colors"
                >
                  Email Us
                </a>
                <a 
                  href="tel:5166822888" 
                  className="inline-flex items-center px-4 py-2 border border-black text-sm uppercase tracking-wider font-medium text-black bg-white hover:bg-gray-100 transition-colors"
                >
                  Call Us: 516-682-2888
                </a>
              </div>
