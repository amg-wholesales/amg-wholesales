...
import SearchBar from "@/components/category/SearchBar";
import Pagination from "@/components/category/Pagination";
import CategoryContentSection from "../app/product/_components/CategoryContentSection";
import { 
  ChevronRight, 
  Filter, 
  SlidersHorizontal, 
...
export default function CategoryPage() {
  ...
  // Helper function to convert URL parameter to data key
  const convertUrlToDataKey = (urlCategory) => {
    // Convert kebab-case to UPPER CASE with spaces
    return urlCategory
      .split('-')
      .join(' ')
      .toUpperCase();
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Category Content Section - FIXED: Convert URL to proper data key */}
        <CategoryContentSection categoryKey={convertUrlToDataKey(category)} />
      </div>
