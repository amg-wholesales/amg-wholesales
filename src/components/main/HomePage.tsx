...
// Hero media with support for both images and videos
const heroMedia = [
...
export default function HomePage() {
  ...
  // Hero slider auto change - Updated to use heroMedia
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentSlide((prev) => (prev === heroMedia.length - 1 ? 0 : prev + 1));
    }, 6000);
  ...
  // Updated slide navigation functions to use heroMedia
  const nextSlide = () => {
    setCurrentSlide((prev) => (prev === heroMedia.length - 1 ? 0 : prev + 1));
  };
  
  const prevSlide = () => {
    setCurrentSlide((prev) => (prev === 0 ? heroMedia.length - 1 : prev - 1));
  };
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-screen">
        {/* Updated hero media rendering with support for images and videos */}
        ...
        {/* Hero slider navigation - Updated to use heroMedia */}
